...
class OurArguments(TrainingArguments):
    ...
    quantized_model_dir:str = '/work/LAS/wzhang-lab/mingl/code/QMeZO/AutoGPTQ/examples/quantization/opt-13b-4bit-32g'
...
def custom_forward(self, x):
        ...
        if self.autogptq_cuda_available is True and (
            ...
            if hasattr(self, 'mezo_part'):
                ...
                # out_lora = (x.half() @ self.lora_A.transpose(0, 1) @ self.lora_B.transpose(0, 1)) * self.scaling
